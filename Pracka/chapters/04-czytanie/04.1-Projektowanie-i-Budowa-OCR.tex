...
Zdjęcia w formacie JPEG są wczytywane za pomocą biblioteki Pillow \cite{pillow_docs},
która umożliwia konwersję obrazów do przestrzeni barw RGB, zapewniając jednolitość formatów danych wejściowych.
...
a używana kość ma jednolity, jasny kolor.
...
które umożliwiają wykrycie konturu i obliczenie otaczającego go prostokąta.
...
Konwersja do skali szarości dodatkowo minimalizuje wpływ odblasków powstających,
gdy kość odbija światło wprost do kamery, co poprawia niezawodność analizy.
