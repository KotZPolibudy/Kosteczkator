...
Na rysunkach\ref{fig:4raw} oraz\ref{fig:4proc} przedstawiono przykładowe zdjęcie surowe oraz poddane już wstępnemu przetwarzaniu.
...
%% TODO Czy np. dodać elementy pośrednie? - idk
