...
\begin{itemize}
    \item Jakub Kędra zaprojektował i wykonał część sprzętową, łącznie z projektem i wydrukiem wszystkich części.
    \item Wojciech Kot zaprojektował i zaimpelentował OCR wraz z wchodzącą w jego skład siecią neuronową i obróbką graficzną zdjęć. Jest głównym pomysłodawcą projektu. 
    \item Julia Samp przygotowała, przeprowadziła oraz opracowała testy statystyczne otrzymanych wyników. 
    \item Jakub Prusak wykonał integrację maszyny z systemem Linux oraz zrównoleglenie przetwarzania.
\end{itemize}
