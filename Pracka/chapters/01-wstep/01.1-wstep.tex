...
\begin{itemize}
    ...
    \item Wojciech Kot zaprojektował i zaimpelentował OCR i część związaną z siecią neuronową. Jest głównym pomysłodawcą projektu. 
    \item Julia Samp przygotowała, przeprowadziła oraz opracowała testy statystyczne otrzymanych wyników. 
    \item Jakub Prusak wykonał integrację maszyny z systemem Linux.
\end{itemize}
