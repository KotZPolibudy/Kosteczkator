...
\begin{itemize}
    \item Rozdział~\ref{ch:przeglad-rynku} przedstawiono przegląd obecnie dostępnych rozwiązań,
    ...
    \item Rozdział~\ref{ch:odczytywanie-losowego-wyniku-z-kosci} skupiają się już jedynie na oprogramowaniu
    ...
    \item Rozdział~\ref{ch:komunikacja} opisuje protokołu komunikacji z innym urządzeniem odbierającym wynik pracy robota. 
