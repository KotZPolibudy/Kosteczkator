...
\subsubsection{Elektronika:}
    \begin{itemize}
        ...
        \item Raspberry Pi Camera V2 - kamera przystosowania do łączenia z Raspberry Pi za pomocą taśmy Raspberry Pi. Posiada ona 8-megapixelowy sensor Sony IMX219.
