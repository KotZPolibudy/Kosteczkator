...
obniżała by jakość wydruku komponentów robota, które zawierają wiele otworów drukowanych w płaszczyźnie pionowej a to sprzyjałoby nitkowaniu~\cite{PLA,PETG,ABS,PLA2}.
    \begin{itemize}
        \item obudowa,
