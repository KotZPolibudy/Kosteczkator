...
W tym celu postanowiono skontrułować mechanizm wchylający cały kubek przez co siła ciężkości zaczełaby dociskać ją do bocznych ścian kubka. W takim ułożeniu po wprowadzeniu
...
wentylatora udało się obniżyć temperaturę pracy procesora. Praca wentylatora jest sterowana przy pomocy układu tranzystorów Darlingtona, złącza GPIO Raspberry Pi oraz programu 
